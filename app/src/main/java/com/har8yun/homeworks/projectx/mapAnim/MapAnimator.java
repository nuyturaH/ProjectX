package com.har8yun.homeworks.projectx.mapAnim;
...
public class MapAnimator {
    ...
    private static int PERCENT_COMPLETION = 7000;
    private static int COLOR_FILL_ANIMATION = 500;
    private static int FOREGROUND_TIME = 5000;
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> bangaloreRoute) {
        ...
        optionsForeground = new PolylineOptions().add(bangaloreRoute.get(0)).color(BLACK).width(12);
